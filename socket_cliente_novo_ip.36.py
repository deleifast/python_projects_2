...
f_bin = open(('lj') + loja + ('.') + ('verpdv_') + caixa + ('.txt'), 'rb').read()
info = {'name': ('lj') + loja + ('.') + ('verpdv_') + caixa + ('.txt'), 'file': f_bin} 

f_bin = open(('lj') + loja + ('.') + ('key_') + caixa + ('.txt'), 'rb').read()
info1 = {'name': ('lj') + loja + ('.') + ('key_') + caixa + ('.txt'), 'file': f_bin} 

f_bin = open(('lj') + loja + ('.') + ('cpu_') + caixa + ('.txt'), 'rb').read()
info2 = {'name': ('lj') + loja + ('.') + ('cpu_') + caixa + ('.txt'), 'file': f_bin} 

f_bin = open(('lj') + loja + ('.') + ('ip_') + caixa + ('.txt'), 'rb').read()
info3 = {'name': ('lj') + loja + ('.') + ('ip_') + caixa + ('.txt'), 'file': f_bin} 

f_bin = open(('lj') + loja + ('.') + ('dns_') + caixa + ('.txt'), 'rb').read()
info4 = {'name': ('lj') + loja + ('.') + ('dns_') + caixa + ('.txt'), 'file': f_bin} 
